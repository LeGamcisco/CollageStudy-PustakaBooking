        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link <?php if ($judul == "Katalog Buku") { echo 'active'; } ?>" href="<?= base_url(); ?>">Beranda <span class="sr-only">(current)</span></a>
                    <?php
                    if (!empty($this->session->userdata('email'))) { ?>
                        <a class="nav-item nav-link <?php if ($judul == "Data Booking") { echo 'active'; } ?>" href="<?= base_url('booking') ?>">Booking <b><?= $this->ModelBooking->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?></b> Buku</a>
                        <a class="nav-item nav-link <?php if ($judul == "Profil Saya") { echo 'active'; } ?>" href="<?= base_url('member/myprofil'); ?>">Profil Saya</a>
                        <a class="nav-item nav-link <?php if ($judul == "Daftar Anggota Kelompok 5") { echo 'active'; } ?>" href="<?= base_url('kelompok'); ?>">Anggota Kelompok</a>
